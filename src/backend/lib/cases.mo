...
module {
  ...
  public func createCase(
    ...
    let c : CasesT.Case = {
      ...
      deadline;
      var isPublic        = false;
      var verificationStatus = #PendingAdminApproval;
      var documents       = [];
      createdAt           = Time.now();
      var adminNote       = null;
    };
  ...
  /// Only cases that have been admin-approved (isPublic = true) appear here.
  ...
  /// Approve a case for public display (admin)
  public func approveCase(
    cases     : Map.Map<Nat, CasesT.Case>,
    caseId    : Nat,
    adminNote : ?Text,
  ) {
  ...
  /// Reject a case — hides it from Browse Cases (admin)
  public func rejectCase(
    cases     : Map.Map<Nat, CasesT.Case>,
    caseId    : Nat,
    adminNote : ?Text,
  ) {
    ...
    c.isPublic           := false;
    c.verificationStatus := #RejectedByAdmin;
    c.adminNote          := adminNote;
  };

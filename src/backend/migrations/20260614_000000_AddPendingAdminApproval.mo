...
module {
  ...
  // ── OldActor VerificationStatus: 3 constructors ───────────────────────────
  type OldVerificationStatus = {
    #Unverified; #DocumentsSubmitted; #InstitutionVerified;
  };

  // ── NewActor VerificationStatus: 5 constructors ───────────────────────────
  type NewVerificationStatus = {
    #PendingAdminApproval; #Unverified; #DocumentsSubmitted;
    #InstitutionVerified; #RejectedByAdmin;
  };
  ...
  // OldCase uses OldVerificationStatus
  type OldCase = {
    id                     : Nat;
    createdBy              : UserId;
    var title              : Text;
    ...
    deadline               : Timestamp;
    var isPublic           : Bool;
    var verificationStatus : OldVerificationStatus;
    var documents          : [FileRef];
    createdAt              : Timestamp;
    var adminNote          : ?Text;
  };

  // NewCase uses NewVerificationStatus
  type NewCase = {
    id                     : Nat;
    createdBy              : UserId;
    var title              : Text;
    ...
    deadline               : Timestamp;
    var isPublic           : Bool;
    var verificationStatus : NewVerificationStatus;
    var documents          : [FileRef];
    createdAt              : Timestamp;
    var adminNote          : ?Text;
  };
  ...
  type DepositMethod = {
    #EasyPaisa; #JazzCash; #BankTransfer; #USDT; #ICP;
  };

  type DepositStatus = { #PendingApproval; #Approved; #Rejected };
  ...
  // ── OldActor: exactly NewActor from 20260613_000000_AddCallerPrincipalIndex ─
  type OldActor = {
    ...
    callerPrincipalIndex : Map.Map<Text, UserId>;
  };

  // ── NewActor: same shape; cases field now uses NewVerificationStatus ───────
  type NewActor = {
    accessControlState   : AccessControl.AccessControlState;
    users                : Map.Map<UserId, User>;
    heroStats            : Map.Map<UserId, HeroStats>;
  ...
  // ── Migration: cast each case's verificationStatus to the new variant ──────
  public func migration(old : OldActor) : NewActor {
    let migratedCases = old.cases.map<Nat, OldCase, NewCase>(
      func(_, c) {
        let newStatus : NewVerificationStatus = switch (c.verificationStatus) {
          case (#Unverified)          { #Unverified };
          case (#DocumentsSubmitted)  { #DocumentsSubmitted };
          case (#InstitutionVerified) { #InstitutionVerified };
        };
        {
          id                     = c.id;
          ...
          var verificationStatus = newStatus;
    ...
    );
    {
      ...
      depositState         = old.depositState;
      callerPrincipalIndex = old.callerPrincipalIndex;
    };
  };
};

...
module {
  ...
  public type VerificationStatus = {
    #PendingAdminApproval;   // newly submitted — not yet visible on Browse Cases
    #Unverified;             // admin approved; docs not yet submitted
    #DocumentsSubmitted;
    #InstitutionVerified;
    #RejectedByAdmin;        // admin rejected; not visible on Browse Cases
  };

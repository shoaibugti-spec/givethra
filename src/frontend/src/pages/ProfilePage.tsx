...
// Givethra - Complete Profile Page
// Fixed: Own-profile detection so Edit Profile controls render correctly.
...
export default function ProfilePage() {
  ...
  // URL params are normally strings while auth user IDs can be numbers,
  // strings, UUIDs, etc.
  // -------------------------------------------------------------------------
  ...
  const [relationshipType, setRelationshipType] =
    useState<
      "heroes" | "requesters" | "supporters" | null
    >(null);
      ...
      <div className="max-w-xl mx-auto px-4 pt-0 pb-24 space-y-4">
        ...
        <div className="rounded-b-3xl bg-card border border-border shadow-sm overflow-hidden">
          ...
          <div className="px-5 pb-5">
            ...
            <div className="flex items-end justify-between -mt-12 mb-3">
              ...
              <div className="relative shrink-0">
                ...
                {isOwnProfile && (
                  <button
                    ...
                    className="absolute -bottom-1 -right-1 h-8 w-8 rounded-full border-2 border-card bg-primary text-primary-foreground flex items-center justify-center shadow-md hover:bg-primary/90 transition-colors z-10"
                  >
              ...
              {/* Hero button for other profiles */}
              {!isOwnProfile && (
                <Button
                  type="button"
                  onClick={toggleHero}
        ...
        <div className="rounded-2xl bg-card border border-border p-4 space-y-2">
          ...
          <div className="flex justify-between text-[10px] text-muted-foreground">
            ...
            <span>
              +{caseStats.completed * 5}{" "}
              approvals · -
              {caseStats.rejected * 10}{" "}
              rejections · -
              {caseStats.expired * 5}{" "}
              expired
            </span>
              ...
              {cases
                ...
                .map((c: any) => (
                  ...
                  >
                    ...
                    <span
                      className={`shrink-0 text-[10px] font-semibold px-2 py-0.5 rounded-full border capitalize ${getCaseStatusStyle(
                        c.status
                      )}`}
                    >
                      {c.status ||
          ...
          <div className="space-y-3 py-2">
            ...
            <div className="flex items-start gap-3 p-2 rounded-lg bg-muted/30">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  You unlocked a case but did not complete a payment. Take the next step!
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2 rounded-lg bg-muted/30">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  You contributed to a fundraising pool. Every contribution counts!
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2 rounded-lg bg-muted/30">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  You have unlocked, contributed, and provided direct help. The ultimate Hero!
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <DialogContent className="max-w-sm">
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              Turn community Supports into real perks.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-3 py-2 text-sm text-muted-foreground">
            ...
            <p>
              ...
              your posts and cases receive from the community earn you{" "}
              <span className="font-semibold text-foreground">
                1 Credit
              </span>.
            </p>
            ...
            <p>
              ...
              to unlock a reward — submit a new case, unlock a case, or clear an account suspension.
            </p>
          </div>
            ...
            <DialogDescription>
              ...
              {!relationshipLoading &&
                relationshipUsers.length >
                  0 && (
                  <span className="block mt-0.5 text-xs font-medium text-foreground">
                    {
                      relationshipUsers.length
                    }{" "}
                    total

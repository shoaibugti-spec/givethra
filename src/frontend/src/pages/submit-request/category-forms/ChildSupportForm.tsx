    ...
    >
      <div className="space-y-3">
        <TextInput
          ...
          onChange={(v: string) => setField("child_name", v)}
        ...
        <TextInput
          ...
          onChange={(v: string) => setField("child_age", v)}
          placeholder="e.g. 8"
        />
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            {["Both alive", "Father passed away", "Mother passed away", "Both passed away"].map(
              (opt) => (
                <button
                  key={opt}
                  type="button"
        ...
        <TextInput
          ...
          onChange={(v: string) => setField("child_cnic", v)}
        ...
        <FileUpload
          ...
          onUpload={(url: string) => setDoc("child_b_form", url)}
        ...
        <FileUpload
          ...
          onUpload={(url: string) => setDoc("parents_proof", url)}

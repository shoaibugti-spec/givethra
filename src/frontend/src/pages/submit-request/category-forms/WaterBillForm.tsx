...
export default function WaterBillForm({ formData, setFormData, onNext, onBack, isFirst, isLast }: any) {
  ...
  return (
    <BaseCategoryForm
      ...
      subtitle="Provide your water bill details for verification."
      guide="⚠️ One case = ONE bill only. Upload a clear photo of your water bill."
    >
      <div className="space-y-3">
        <div className="space-y-2">
          <Label>Select Your Company *</Label>
          <div className="grid grid-cols-2 gap-2">
            {WATER_COMPANIES.map((c) => (
              <button
                key={c.name}
                type="button"

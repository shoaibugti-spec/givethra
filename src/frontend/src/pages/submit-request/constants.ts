...
export const CURRENCY_SYMBOLS: Record<string, string> = {
  USD: "$", PKR: "Rs", SAR: "SAR", AED: "AED", GBP: "£", EUR: "€",
  INR: "₹", TRY: "₺", BDT: "৳", NPR: "Rs", LKR: "Rs",
};
...
export const UTILITY_CATS: Record<string, { companies: { name: string; ref: string; refHint: string }[] }> = {
...
export const LIST_CATS: Record<string, any> = {
  "School, College & University Fees": {
    ...
    getSubDocs: (subType: string, subValue: string) => getEducationDocs("fee", subType),
  },
  "Education, Books & Admission": {
    list: EDUCATION_INSTITUTES,
    ...
    getSubDocs: (subType: string, subValue: string) => getEducationDocs(subType, subValue),
  },
  "Medical & Treatment": {
...
export const PAYMENT_RECEIVER_CATS = new Set([
  "House Rent", "Food & Groceries", "Medicines", "Home Repair", "Debt Relief",
  "Business / Work Help", "Marriage Support", "Funeral Expenses", "Livestock / Farming", "Emergency Help", "Other",
]);

export const PERSONAL_PAYMENT_CATS = new Set([
  "House Rent", "Marriage Support", "Business / Work Help", "Home Repair",
  "Funeral Expenses", "Livestock / Farming", "Debt Relief", "Emergency Help",
  "Other", "Food & Groceries", "Medicines",
]);

export const FIXED_STIPEND_CATS = new Set(["Child Support", "Widow & Elderly Support", "Disability Support"]);
export const PROPERTY_RELEVANT_CATS = new Set(["Electricity Bill", "Gas Bill", "Water Bill", "House Rent", "Food & Groceries"]);
export const SKIP_FIELDS = new Set(["provider_name", "provider_contact", "landlord_name", "landlord_contact", "creditor_name", "creditor_contact", "receiver_name", "receiver_contact"]);
...
// ===== HELPERS =====
export function isEasyCat(cat: string) { return !!UTILITY_CATS[cat] || !!LIST_CATS[cat]; }
export function getCategoryLimit(category: string) { return CATEGORY_LIMITS[category] || null; }
...
export function getMaxLimit(category: string): number | null { return getMaxAmount(category); }
export function isDebtCategory(category: string): boolean { return category === "Debt Relief"; }

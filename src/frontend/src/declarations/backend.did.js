...
export const VerificationStatus = IDL.Variant({
  ...
  'PendingAdminApproval' : IDL.Null,
  'Unverified' : IDL.Null,
  'RejectedByAdmin' : IDL.Null,
});
...
export const KycSubmission = IDL.Record({
  ...
  'liveVideoUrl' : IDL.Text,
  'userId' : IDL.Text,
  'submittedAt' : IDL.Int,
  'documentFileUrl' : IDL.Text,
});
...
export const DepositRequest = IDL.Record({
  ...
  'userId' : IDL.Text,
  'createdAt' : IDL.Int,
  'proofImageUrl' : IDL.Text,
  'amountSent' : IDL.Float64,
  'updatedAt' : IDL.Int,
  'currency' : IDL.Text,
  'adminNotes' : IDL.Text,
});
...
export const idlService = IDL.Service({
  ...
  'approveCase' : IDL.Func([IDL.Nat, IDL.Opt(IDL.Text)], [CasePublic], []),
  'approveDeposit' : IDL.Func([IDL.Text, IDL.Text], [Result_1], []),
  'approveKyc' : IDL.Func([IDL.Text, IDL.Opt(IDL.Text)], [UserPublic], []),
  ...
  'getCallerWallet' : IDL.Func([], [IDL.Int], ['query']),
  ...
  'getDepositRequest' : IDL.Func([IDL.Text], [Result_2], ['query']),
  ...
  'getKycSubmissionByUserId' : IDL.Func(
      [IDL.Text],
      [IDL.Opt(KycSubmission)],
      ['query'],
    ),
  'getMyConversations' : IDL.Func([], [IDL.Vec(ConversationPublic)], ['query']),
  'getMyKycSubmission' : IDL.Func([], [IDL.Opt(KycSubmission)], ['query']),
  ...
  'getPrivacySettingsByUserId' : IDL.Func(
      [IDL.Text],
      [IDL.Opt(PrivacySettingsPublic)],
      ['query'],
    ),
  ...
  'getUserSettingsByUserId' : IDL.Func(
      [IDL.Text],
      [IDL.Opt(UserSettingsPublic)],
      ['query'],
    ),
  'getWallet' : IDL.Func([], [IDL.Int], ['query']),
  'getWalletByUserId' : IDL.Func([IDL.Text], [IDL.Int], ['query']),
  'isCallerAdmin' : IDL.Func([], [IDL.Bool], ['query']),
  'isStripeConfigured' : IDL.Func([], [IDL.Bool], ['query']),
  'isUnlocked' : IDL.Func([IDL.Nat, UserId], [IDL.Bool], ['query']),
  'listAllDeposits' : IDL.Func([], [IDL.Vec(DepositRequest)], ['query']),
  'listCases' : IDL.Func(
      [IDL.Opt(Category), PageRequest],
      [IDL.Vec(CaseSummary)],
      ['query'],
    ),
  'listPendingCases' : IDL.Func([], [IDL.Vec(CasePublic)], ['query']),
  'listPendingDeposits' : IDL.Func([], [IDL.Vec(DepositRequest)], ['query']),
  ...
  'purchaseCreditsDirect' : IDL.Func([IDL.Nat], [Result], []),
  ...
  'rejectCase' : IDL.Func([IDL.Nat, IDL.Opt(IDL.Text)], [CasePublic], []),
  'rejectDeposit' : IDL.Func([IDL.Text, IDL.Text], [Result_1], []),
  'rejectKyc' : IDL.Func([IDL.Text, IDL.Opt(IDL.Text)], [UserPublic], []),
  ...
  'submitDepositRequest' : IDL.Func(
      [IDL.Text, DepositMethod, IDL.Text, IDL.Text, IDL.Float64, IDL.Text],
      [Result],
      [],
    ),
  'submitKyc' : IDL.Func(
      [
        IDL.Variant({ 'passport' : IDL.Null, 'nationalId' : IDL.Null }),
        IDL.Text,
        IDL.Text,
      ],
      [IDL.Variant({ 'ok' : UserPublic, 'err' : IDL.Text })],
  ...
  'testStateRecovery' : IDL.Func(
      [],
      [
        IDL.Record({
          'kycCount' : IDL.Nat,
          'sampleSessions' : IDL.Vec(ActiveSession),
          'sampleKyc' : IDL.Opt(KycSubmission),
          'sessionCount' : IDL.Nat,
          'userCount' : IDL.Nat,
          'sampleSettings' : IDL.Opt(UserSettingsPublic),
        }),
      ],
      ['query'],
    ),
  ...
  'updatePrivacySettingsByUserId' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Bool, IDL.Bool, IDL.Bool, IDL.Bool, IDL.Bool],
      [PrivacySettingsPublic],
      [],
    ),
  ...
  'updateUserSettingsByUserId' : IDL.Func(
      [
        IDL.Text,
        IDL.Text,
        IDL.Text,
...
export const idlFactory = ({ IDL }) => {
  ...
  const Result_2 = IDL.Variant({ 'ok' : DepositRequest, 'err' : IDL.Text });

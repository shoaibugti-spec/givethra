...
export type CreditTxnKind = { 'SpentOnUnlock' : null } |
  ...
  { 'Purchase' : null } |
  { 'AdminGrant' : null };
export type DepositMethod = { 'ICP' : null } |
  { 'USDT' : null } |
  { 'BankTransfer' : null } |
  { 'JazzCash' : null } |
  { 'EasyPaisa' : null };
...
export type DepositStatus = { 'Approved' : null } |
  { 'Rejected' : null } |
...
export type Result_1 = { 'ok' : null } |
  { 'err' : string };
export type Result_2 = { 'ok' : DepositRequest } |
  { 'err' : string };
...
export interface _SERVICE {
  ...
  'approveCase' : ActorMethod<[bigint, [] | [string]], CasePublic>,
  'approveDeposit' : ActorMethod<[string, string], Result_1>,
  'approveKyc' : ActorMethod<[string, [] | [string]], UserPublic>,
  ...
  'getCallerWallet' : ActorMethod<[], bigint>,
  ...
  'getPrivacySettingsByUserId' : ActorMethod<
    [string],
  ...
  'getUserDeposits' : ActorMethod<[string], Array<DepositRequest>>,
  'getUserSettings' : ActorMethod<[], [] | [UserSettingsPublic]>,
  'getUserSettingsByUserId' : ActorMethod<[string], [] | [UserSettingsPublic]>,
  'getWallet' : ActorMethod<[], bigint>,
  'getWalletByUserId' : ActorMethod<[string], bigint>,
  'isCallerAdmin' : ActorMethod<[], boolean>,
  'isStripeConfigured' : ActorMethod<[], boolean>,
  'isUnlocked' : ActorMethod<[bigint, UserId], boolean>,
  'listAllDeposits' : ActorMethod<[], Array<DepositRequest>>,
  'listCases' : ActorMethod<[[] | [Category], PageRequest], Array<CaseSummary>>,
  'listPendingCases' : ActorMethod<[], Array<CasePublic>>,
  'listPendingDeposits' : ActorMethod<[], Array<DepositRequest>>,
  ...
  'purchaseCreditsDirect' : ActorMethod<[bigint], Result>,
  ...
  'registerWithGoogle' : ActorMethod<
    ...
    { 'ok' : UserPublic } |
      { 'err' : string }
  >,
  'rejectCase' : ActorMethod<[bigint, [] | [string]], CasePublic>,
  'rejectDeposit' : ActorMethod<[string, string], Result_1>,
  'rejectKyc' : ActorMethod<[string, [] | [string]], UserPublic>,
  ...
  'submitDepositRequest' : ActorMethod<
    [string, DepositMethod, string, string, number, string],
    Result
  >,
  'submitKyc' : ActorMethod<
    [{ 'passport' : null } | { 'nationalId' : null }, string, string],
    { 'ok' : UserPublic } |
      { 'err' : string }
  >,
  ...
  'updatePrivacySettings' : ActorMethod<
    ...
    PrivacySettingsPublic
  >,
  'updatePrivacySettingsByUserId' : ActorMethod<
   ...
   * / Confirm unlock fee after Stripe session completes
   */
  'updateUserSettingsByUserId' : ActorMethod<
    [
      string,
      string,
      string,

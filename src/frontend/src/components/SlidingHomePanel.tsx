...
export default function SlidingHomePanel({ children, onTabChange }: SlidingHomePanelProps) {
  ...
  const shellClass = expanded
    ? "fixed inset-x-0 bottom-0 z-40 flex h-[90dvh] max-h-[900px] min-h-[260px] flex-col overflow-hidden rounded-t-[2rem] border border-b-0 border-primary/15 bg-background/95 shadow-[0_-18px_60px_rgba(15,23,42,0.18)] backdrop-blur-xl"

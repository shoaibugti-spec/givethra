import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, u as useNavigate, H as House, B as Briefcase, L as Link } from "./index-BoYH-a4m.js";
import { C as CaseCard } from "./CaseCard-CQf9J5WR.js";
import { C as CATEGORY_EMOJI } from "./CategoryPill-DsTfuf3g.js";
...
import { P as Phone } from "./phone-DgzjNGSN.js";
import { B as Building2 } from "./building-2-BwLyqQLr.js";
import "./card-BFaW8de3.js";
import "./progress-CORsrKER.js";
import "./index-DZCQKErg.js";
import "./index-BGoXbzZj.js";
import "./VerificationBadge-BSpB1IIY.js";
import "./map-pin-BChSBW_d.js";
...
const Baby = createLucideIcon("baby", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MailCheck = createLucideIcon("mail-check", __iconNode$4);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const BROWSE_CATEGORIES = [
  ...
  { name: "Housing", icon: House, count: 0, emoji: "🏠" },
...
function HomePage() {
  ...
  const pillsRef = reactExports.useRef(null);
  reactExports.useEffect(() => {
    if (!actor || isFetching) return;
    actor.listCases(null, { offset: BigInt(0), limit: BigInt(6) }).then(setCases);
  }, [actor, isFetching]);
  const liveCases = cases.map(toCardData);
  const displayCases = liveCases;
  const filteredCases = filterCat === "all" ? displayCases : displayCases.filter((c) => c.category === filterCat);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background pb-20 md:pb-0", children: [
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-24 -right-24 h-72 w-72 rounded-full bg-primary/10 blur-3xl" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-0 -left-16 h-48 w-48 rounded-full bg-primary/8 blur-2xl" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-7xl mx-auto px-4 pt-8 pb-0 md:py-16 flex flex-col md:flex-row items-center gap-6 md:gap-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full bg-primary/10 border border-primary/20 px-3 py-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-3.5 w-3.5 text-primary" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-primary tracking-wide uppercase", children: "GIVETHRA" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl md:text-5xl lg:text-6xl font-bold text-foreground leading-tight", children: [
                    "Verified Help.",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Real Impact." })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base md:text-lg text-muted-foreground max-w-md", children: "Connect with verified people, support genuine needs, and create meaningful impact." }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 justify-center md:justify-start", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-5 justify-center md:justify-start pt-1", children: [
                    { val: "0", label: "Cases Verified" },
                    { val: "0", label: "Heroes" },
                    { val: "$0", label: "Directly Supported" }
                  ].map(({ val, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center md:text-left", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-lg font-bold text-foreground", children: val }),
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  className: `inline-flex items-center gap-1 rounded-full border font-medium whitespace-nowrap px-3 py-1.5 text-sm transition-smooth shrink-0 ${filterCat === "all" ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-muted-foreground border-border hover:border-primary hover:text-primary"}`,
                  children: "All"
                }
              ),
              FILTER_CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  "data-ocid": `home.category_pill.${cat.toLowerCase().replace(/ /g, "_")}`,
                  onClick: () => setFilterCat(filterCat === cat ? "all" : cat),
                  className: `inline-flex items-center gap-1.5 rounded-full border font-medium whitespace-nowrap px-3 py-1.5 text-sm transition-smooth shrink-0 ${filterCat === cat ? "bg-primary text-primary-foreground border-primary shadow-sm" : "bg-card text-muted-foreground border-border hover:border-primary hover:text-primary"}`,
                  children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground", children: "Browse Help Categories" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3", children: BROWSE_CATEGORIES.map(({ name, icon: Icon, count }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.button,
            {
              type: "button",
              ...
              onClick: () => {
                var _a;
                setFilterCat(name);
                (_a = document.getElementById("featured-cases")) == null ? void 0 : _a.scrollIntoView({ behavior: "smooth" });
              },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-11 w-11 rounded-xl bg-primary/10 flex items-center justify-center group-hover:bg-primary/15 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-5 w-5 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-foreground leading-tight", children: name }),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-lg font-bold text-foreground", children: [
              ...
              filterCat !== "all" && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-primary", children: [
                "· ",
                filterCat
              ] })
            ] }),
          ...
          filteredCases.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "home.cases_empty_state",
              className: "text-center py-16 rounded-xl border border-dashed border-border bg-muted/20",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-semibold text-base", children: "No verified cases available yet." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Be the first verified request on Givethra." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
                  {
                    variant: "outline",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4", children: filteredCases.slice(0, 6).map((c, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground mb-5 text-center", children: "Built on Trust & Verification" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: TRUST_BADGES.map(({ icon: Icon, label, color: color2 }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 w-9 rounded-lg bg-card flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-5 w-5 ${color2}` }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(BadgeCheck, { className: "h-3 w-3 text-emerald-500" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: label })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: "Verified" })
                ] })
              ]
            },
            label
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-lg font-bold text-foreground text-center", children: "How Givethra Works" }),
          ...
          ].map(({ step, title, desc, emoji }, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              initial: { opacity: 0, y: 20 },
              whileInView: { opacity: 1, y: 0 },
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-3 left-4 text-xs font-black font-display text-primary/30", children: step }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto text-center space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl md:text-3xl font-bold", children: "Ready to make a difference?" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/80 text-sm", children: "Join thousands of Heroes changing lives through verified, direct support." }),

import { c as createLucideIcon, u as useAuth, f as useNavigate, r as reactExports, j as jsxRuntimeExports, z as HeartHandshake, a$ as z, h as useRole, b0 as useRouterState, L as Link, az as User, i as getUnreadNotificationsCount, t as getCommunityPosts, a2 as cn } from "./main-g9K_ERoM.js";
import { B as Button } from "./button-B16x4Aev.js";
import { X, S as Shield } from "./x-0HxdDPFz.js";
import { H as Heart } from "./heart-jbpX9LjB.js";
import { B as Bell, a as Lock, F as Facebook, I as Instagram, L as Linkedin } from "./lock-VvpKTfA-.js";
...
function RoleSwitcher({ supportPostCount = 0 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 rounded-full border border-border/50 bg-muted p-1 shadow-sm", "aria-label": "Home view switcher", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", "aria-label": "Home", "aria-pressed": activeTab === "support", onClick: () => {
      ...
      navigate({ to: "/home" });
    }, disabled: switching, className: `flex cursor-pointer items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-semibold transition-all active:scale-[.97] ${activeTab === "support" ? "bg-primary text-primary-foreground shadow-md" : "text-muted-foreground hover:bg-background hover:text-foreground"}`, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", "aria-label": "Earnings", "aria-pressed": activeTab === "earning", onClick: () => handleSwitch("earning"), disabled: switching, className: `relative flex cursor-pointer items-center gap-1.5 rounded-full px-3 py-1.5 text-sm font-semibold transition-all active:scale-[.97] ${activeTab === "earning" ? "bg-primary text-primary-foreground shadow-md" : "text-muted-foreground hover:bg-background hover:text-foreground"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-4 w-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Earnings" }),
      supportPostCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-1 -top-1 min-w-5 rounded-full bg-red-600 px-1.5 py-0.5 text-[10px] leading-4 text-white shadow-sm", children: supportPostCount > 99 ? "99+" : supportPostCount }) : null
    ] })
  ] });
}
...
function Layout({ children }) {
  ...
  const [supportPostCount, setSupportPostCount] = reactExports.useState(0);
  ...
  reactExports.useEffect(() => {
    ...
    const loadSupportPostCount = async () => {
      try {
        ...
        const newest = posts.reduce((max, post) => Math.max(max, new Date((post == null ? void 0 : post.created_at) || 0).getTime()), 0);
        const seen = Number(localStorage.getItem("givethra_my_help_posts_seen_at") || 0);
        if (!cancelled) setSupportPostCount(seen ? posts.filter((post) => new Date((post == null ? void 0 : post.created_at) || 0).getTime() > seen).length : 0);
    ...
    const timer = window.setInterval(loadSupportPostCount, 2e4);
    const handleSupportPostsSeen = (event) => {
      var _a;
      const newest = Number(((_a = event.detail) == null ? void 0 : _a.newest) || Date.now());
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-card border-b border-border shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-3 md:px-4 h-16 flex items-center gap-2 md:gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex items-center justify-center", children: isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(RoleSwitcher, { supportPostCount }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden md:block border-t border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 h-10 flex items-center gap-6", children: [
        ...
        isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/my-help", children: "My Help" }),
        isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/my-cases", children: "My Cases" }),
      ...
      menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden border-t border-border bg-card px-4 py-4 space-y-1", children: [
        ...
        isAuthenticated && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/my-help", onClick: closeMenu, children: "My Help" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(NavLink, { to: "/my-cases", onClick: closeMenu, children: "My Cases" }) }),

import { r as reactExports, M as getCasesByUser, l as jsxRuntimeExports, J as uploadFileToStorage, e as useAuth, p as ue, N as getUserSuspension, b as getWallet, O as getFeedbacks, P as insertCaseSubmission, u as useNavigate, g as getKycStatus, L as Link } from "./main-Cdc0HMQw.js";
...
function SubmitRequestWizard() {
  ...
  const currentValue = currentStepId === "whyHelp" ? formData.description : currentStepId === "terms" ? formData.confirmed : formData[currentStepId] ?? "";

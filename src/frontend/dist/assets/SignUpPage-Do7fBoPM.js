import { e as useAuth, l as jsxRuntimeExports, L as Link } from "./main-Cdc0HMQw.js";
import { B as Button } from "./button-M4vBmj7v.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from "./card-Cb8eBPri.js";
...
function SignUpPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full max-w-md border-border shadow-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "text-center space-y-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-2xl font-bold", children: "Join Givethra" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Create your account using Google" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-center text-sm text-muted-foreground", children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/sign-in", className: "text-primary font-medium hover:underline", children: "Sign in" })
      ] })
    ] })
  ] }) });
}

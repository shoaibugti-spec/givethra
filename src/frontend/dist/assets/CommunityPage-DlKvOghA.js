import { f as useNavigate, u as useAuth, r as reactExports, j as jsxRuntimeExports, az as User, b7 as getGuestId, t as getCommunityPosts, o as ue, v as createCommunityPost, b2 as toggleLike, y as supportPost, b4 as addComment, w as unfollowUser, x as followUser, b3 as getPostComments } from "./main-g9K_ERoM.js";
...
import { M as MessageCircle } from "./message-circle-Ds5NPe60.js";
...
function CommunityPage() {
  ...
  const fetchPosts = async (showLoader = false) => {
    ...
    try {
      const rankSeed = feedTab === "for-you" ? (Date.now() ^ Math.floor(Math.random() * 2147483647)) % 2147483647 : void 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-6 space-y-6", children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `rounded-lg px-4 py-2.5 text-sm font-semibold transition-colors ${feedTab === "latest" ? "bg-card text-primary shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
              children: "Latest"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `rounded-lg px-4 py-2.5 text-sm font-semibold transition-colors ${feedTab === "most-supported" ? "bg-card text-primary shadow-sm" : "text-muted-foreground hover:text-foreground"}`,
              children: "Most Supported"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: feedTab === "my-posts" ? "You have not shared a post yet." : "No posts yet. Be the first to share!" })

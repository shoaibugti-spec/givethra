...
function GoogleSignUp() {
  ...
  if (!configured) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground text-center", children: "Use Phone or Email sign-up in the meantime." })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: "Create your account using your Google account." }),
...
function PhoneSignUp() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    step === "phone" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSendOtp, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "signup-otp", children: "Enter OTP" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            id: "signup-otp",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          className: "w-full h-11 font-semibold",
          children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "sm" }) : "Verify & Create Account"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
...
function EmailSignUp() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "signup-email", children: "Email Address" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Input,
        {
          id: "signup-email",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        className: "w-full h-11 font-semibold",
        children: isLoggingIn ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "sm" }) : "Create Account"
      }
    )
  ] });
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-6 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "google", className: "w-full", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "grid w-full grid-cols-3 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "google", "data-ocid": "signup.google_tab", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "phone", "data-ocid": "signup.phone_tab", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-3.5 w-3.5 mr-1" }),
            " Phone"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "email", "data-ocid": "signup.email_tab", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3.5 w-3.5 mr-1" }),
            " Email"
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "google", children: /* @__PURE__ */ jsxRuntimeExports.jsx(GoogleSignUp, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "phone", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PhoneSignUp, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "email", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EmailSignUp, {}) })
      ] }),

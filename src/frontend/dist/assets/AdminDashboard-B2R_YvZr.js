import { c as createLucideIcon, u as useAuth, f as useNavigate, r as reactExports, a7 as adminGetAllKyc, a8 as adminGetAllCases, a9 as adminGetAllResolutions, aa as adminGetAllDeposits, ab as adminGetAllProfiles, ac as adminGetAllWallets, ad as adminGetAllUnlocks, ae as adminGetAllSupportMessages, af as adminGetAllFeedbacks, ag as adminGetAllOffers, ah as adminGetAllSuspensions, ai as adminGetWithdrawals, o as ue, j as jsxRuntimeExports, aj as TriangleAlert, ak as adminUpdateWithdrawal, al as adminUpdateKyc, am as adminUpdateProfile, an as adminGetUserSuspension, ao as adminUpsertUserSuspension, ap as adminUpdateCase, aq as adminGetCategoryOffer, ar as adminUpsertCategoryOffer, as as adminGetWalletsByUser, at as adminUpsertWallet, au as adminUpdateFeedback, av as adminUpdateResolution, aw as adminCloseCase, ax as adminUpdateDeposit, ay as adminDeleteFiles, _ as Wallet, az as User, N as uploadFileToStorage, aA as adminBroadcastNotification, aB as adminSendSupportReply, aC as adminMarkSupportMessagesAsRead } from "./main-g9K_ERoM.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-C5UnQSCg.js";
import { T as Textarea } from "./textarea-CHiADSLq.js";
import { a as sendNotification } from "./notify-BECHcwmP.js";
import { S as Shield } from "./x-0HxdDPFz.js";
...
import { C as CircleX } from "./circle-x-CYqWF1Ro.js";
import { B as Building2 } from "./building-2-BdgUmHb9.js";
import { S as Send } from "./send-BAO8pCdh.js";
...
const ADMIN_EMAILS = /* @__PURE__ */ new Set([
...
function AdminPage() {
  ...
  const [feedbackBusyId, setFeedbackBusyId] = reactExports.useState(null);
  reactExports.useEffect(() => {
    if (!isAuthenticated) {
      navigate({ to: "/sign-in" });
      return;
    }
    if (!ADMIN_EMAILS.has(String((user == null ? void 0 : user.email) || "").toLowerCase())) {
      navigate({ to: "/" });
      return;
    }
    loadData();
  ...
  async function updateFeedback(fbId, status, reason = "") {
    ...
    try {
      await adminUpdateFeedback(fbId, { status, reviewed_at: reviewedAt, reviewed_by: user == null ? void 0 : user.email, rejection_reason: reason });
      setFeedbacks((current) => current.map((item) => item.id === fbId ? { ...item, status, reviewed_at: reviewedAt, reviewed_by: user == null ? void 0 : user.email, rejection_reason: reason } : item));
      ...
      ue.success(status === "approved" ? "Feedback approved and published." : "Feedback rejected.");
    } catch (error) {
      console.error("Feedback update failed:", error);
      ue.error(`Feedback update failed: ${(error == null ? void 0 : error.message) || "Please try again."}`);
    } finally {
  ...
  const visibleFeedbacks = completedCaseFeedbacks.filter((fb) => {
  ...
  const usersList = profiles.map((p) => {
    const uid = p.user_id;
    const kyc = kycList.filter((k) => k.user_id === uid).sort((a, b) => Number(Boolean(b.is_current)) - Number(Boolean(a.is_current)) || new Date(b.submitted_at ?? 0).getTime() - new Date(a.submitted_at ?? 0).getTime())[0];
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20 text-muted-foreground", children: "Loading..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "flex-wrap h-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "feedback", children: [
          "Feedback ",
          feedbacks.filter((f) => f.status === "pending_review").length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 bg-red-500 text-white text-[10px] rounded-full px-1.5", children: feedbacks.filter((f) => f.status === "pending_review").length })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsTrigger, { value: "earnings-withdrawals", children: [
          "Earnings Withdrawals ",
          withdrawals.filter((w) => w.status === "pending").length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1 bg-amber-500 text-white text-[10px] rounded-full px-1.5", children: withdrawals.filter((w) => w.status === "pending").length })
        ] })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "feedback", className: "space-y-4 mt-4", children: [
        ...
        visibleFeedbacks.filter((f) => feedbackStatusFilter === "all" || f.status === feedbackStatusFilter).length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Empty, { text: feedbackStatusFilter === "all" ? "No seeker feedback submitted yet — required caption and video are missing." : "No matching feedback" }) : visibleFeedbacks.filter((f) => feedbackStatusFilter === "all" || f.status === feedbackStatusFilter).map((fb) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackCard, { fb, profileMap, caseList, onUpdate: updateFeedback, busyId: feedbackBusyId }, fb.id))
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "earnings-withdrawals", className: "space-y-4 mt-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-amber-200 bg-amber-50/40 p-4 dark:bg-amber-950/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold", children: "Earnings Withdrawals" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: "This is separate from the Credits Wallet. Review the manual PKR payout and attach payment proof." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3", children: withdrawals.length ? withdrawals.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: w.full_name || w.email || w.user_id }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-muted px-2.5 py-1 text-xs font-bold capitalize", children: w.status })
          ] }),
          w.payment_proof_url ? /* @__PURE__ */ jsxRuntimeExports.jsx("a", { className: "mt-2 inline-block text-xs font-semibold text-primary underline", href: w.payment_proof_url, target: "_blank", rel: "noreferrer", children: "View payment proof" }) : null,
          w.status === "pending" || w.status === "approved" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: () => void adminUpdateWithdrawal(w.id, { status: "approved" }).then(loadData), children: "Approve" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => void adminUpdateWithdrawal(w.id, { status: "rejected" }).then(loadData), children: "Reject" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("input", { placeholder: "Payment proof URL", className: "h-9 min-w-56 flex-1 rounded-md border bg-background px-3 text-xs", id: `proof-${w.id}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: () => {
              var _a2;
              const proof = (_a2 = document.getElementById(`proof-${w.id}`)) == null ? void 0 : _a2.value.trim();
              if (proof) void adminUpdateWithdrawal(w.id, { status: "completed", payment_proof_url: proof }).then(loadData);
            }, children: "Complete + Proof" })
          ] }) : null
        ] }, w.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "No earnings withdrawal requests yet." }) })
      ] })
    ] })
  ] }) });
}
...
function FeedbackCard({ fb, profileMap, caseList, onUpdate, busyId }) {
  var _a;
  const [reason, setReason] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border bg-card p-4 space-y-3", children: [
    ...
    status === "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-red-200 bg-red-50 p-3 text-xs text-red-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Rejection reason:" }),
      " ",
      fb.rejection_reason || "No reason recorded."
    ] }),
    status === "pending_review" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 pt-1 border-t border-border", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", disabled: busy, className: "bg-teal-600 hover:bg-teal-700 text-white", onClick: () => onUpdate(fb.id, "approved"), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheckBig, { className: "h-3.5 w-3.5 mr-1" }),
          " ",
          busy ? "Saving..." : "Approve — Post to Wall"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", disabled: busy, variant: "outline", className: "text-red-600 border-red-300", onClick: () => onUpdate(fb.id, "rejected", reason), children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-3.5 w-3.5 mr-1" }),
          " ",
          busy ? "Saving..." : "Reject"
        ] })
...
function UserCard({ u, onSuspendChange, onManualUnlock }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-xl border bg-card overflow-hidden ${u.isSuspended ? "border-red-400" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setOpen(!open), className: "w-full flex items-center justify-between gap-3 p-4 hover:bg-muted/30 transition-colors text-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-muted-foreground truncate font-mono", children: [
            "User ID: ",
            u.user_id,
            " · KYC: ",
            u.kycId || "—"
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-4 pt-1 border-t border-border bg-muted/20 space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-card border border-border p-3 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-primary flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "h-3 w-3" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Username", value: u.username }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Full Name", value: u.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Email Address", value: u.email }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "User ID", value: u.user_id, mono: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "KYC ID", value: u.kycId || "Not submitted", mono: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Phone Number", value: u.phone || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Country", value: u.country || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "City", value: u.city || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Joined", value: u.created_at ? new Date(u.created_at).toLocaleString() : "—" })
        ] }),
        u.bio && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground border-t border-border pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Bio:" }),
          " ",
          u.bio
        ] })
      ] }),
      u.kycDetails && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg bg-blue-50 dark:bg-blue-950/20 border border-blue-200 p-3 space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-blue-700 flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { className: "h-3 w-3" }),
          " Complete KYC Details"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-1.5 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "KYC Status", value: u.kycDetails.status || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Document Type", value: u.kycDetails.document_type || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "KYC Full Name", value: u.kycDetails.full_name || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Date of Birth", value: u.kycDetails.date_of_birth || "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "CNIC / Passport Number", value: u.kycDetails.cnic_number || "—", mono: true }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Submitted At", value: u.kycDetails.submitted_at ? new Date(u.kycDetails.submitted_at).toLocaleString() : "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Reviewed At", value: u.kycDetails.reviewed_at ? new Date(u.kycDetails.reviewed_at).toLocaleString() : "—" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DetailRow, { label: "Reviewed By", value: u.kycDetails.reviewed_by || "—" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-blue-200 pt-2 text-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Address:" }),
            " ",
            u.kycDetails.address || "—"
          ] }),
          u.kycDetails.rejection_reason && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-red-600 mt-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Rejection Reason:" }),
            " ",
            u.kycDetails.rejection_reason
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 text-xs", children: [["CNIC Front", u.kycDetails.cnic_front_url], ["CNIC Back", u.kycDetails.cnic_back_url], ["Selfie", u.kycDetails.selfie_url], ["Passport", u.kycDetails.passport_url], ["Face Video", u.kycDetails.face_video_url]].map(([label, url]) => url ? /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: String(url), target: "_blank", rel: "noopener noreferrer", className: "text-primary underline", children: [
          label,
          " ↗"
        ] }, String(label)) : null) })
      ] }),

import { A as useParams, f as useNavigate, u as useAuth, r as reactExports, B as getFeedbackForCase, C as getCaseById, D as getCaseUnlock, E as getUserUnlockCount, F as getCaseResolutions, G as getKycSubmission, a as getProfile, b as getWallet, o as ue, j as jsxRuntimeExports, R as RefreshCw, I as insertCaseUnlock, J as insertCaseResolution, K as updateCaseResolution, M as insertFeedback, N as uploadFileToStorage } from "./main-g9K_ERoM.js";
...
import { C as CircleAlert } from "./circle-alert-BzmTpd2X.js";
import { C as CalendarClock } from "./calendar-clock-C2H2yi5s.js";
import { E as Eye } from "./eye-DR56Jhvf.js";
...
function CaseDetailPage() {
  ...
  const [seekerProfile, setSeekerProfile] = reactExports.useState(null);
  ...
  const recTimerRef = reactExports.useRef(0);
  ...
  async function loadCase() {
    ...
    try {
      ...
      if (user && data) {
        ...
        const [fullUnlock, contributionUnlock, mediaUnlock, count, res, kyc, prof, seekerProf] = results.map((r) => r.status === "fulfilled" ? r.value : null);
  ...
  const educationRows = [
    ...
    { label: "Institute", value: (caseData == null ? void 0 : caseData.institute_name) || categoryDetails.institute_name || categoryDetails.provider },
    { label: "Institute Contact", value: (caseData == null ? void 0 : caseData.institute_contact) || categoryDetails.institute_contact, mono: true },
    { label: "Institute Address", value: (caseData == null ? void 0 : caseData.institute_address) || categoryDetails.institute_address }
  ].filter((row) => Boolean(row.value));
  const medicalRows = [
  ...
  const seekerName = (seekerProfile == null ? void 0 : seekerProfile.full_name) || (seekerKyc == null ? void 0 : seekerKyc.full_name) || (caseData == null ? void 0 : caseData.full_name) || "Verified Help Seeker";
  const seekerContact = (seekerProfile == null ? void 0 : seekerProfile.phone_number) || (seekerProfile == null ? void 0 : seekerProfile.phone) || (caseData == null ? void 0 : caseData.seeker_phone) || (caseData == null ? void 0 : caseData.phone_number);
  const isEducationCase = /school|college|university|education|fee/i.test(String((caseData == null ? void 0 : caseData.category) || "")) || Boolean(categoryDetails.fee_challan);
  const isMedicalCase = /medical|hospital|treatment/i.test(String((caseData == null ? void 0 : caseData.category) || "")) || Boolean(categoryDetails.medical_bill);
  ...
  async function submitFeedback() {
    if (!fbText.trim() || !fbVideoFile) {
      ue.error("Please write a caption AND record the required live-camera video.");
      return;
    }
    if (recording) {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-5", children: [
        ...
        isOwner && isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-teal-50 dark:bg-teal-950/20 border-2 border-teal-200 p-5 space-y-4", children: [
          ...
          existingFeedback && String(existingFeedback.status || "").toLowerCase() !== "rejected" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card border border-border p-4 text-center space-y-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Your video feedback is awaiting Admin review." })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "A live-camera feedback video is required. Write your caption and record a clear video between 60 and 90 seconds." }),
              (existingFeedback == null ? void 0 : existingFeedback.status) === "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-red-200 bg-red-50 p-3 text-left text-xs text-red-700", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold", children: "Your previous feedback was rejected." }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-1", children: [
                  "Reason: ",
                  existingFeedback.rejection_reason || "Admin requested a clearer video or caption."
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1", children: "Please record a new video and submit your feedback again." })
              ] })
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold", children: "Feedback video (required · live camera · 60–90 seconds)" }),
              fbVideoBlob ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "button", className: "w-full min-h-12 touch-manipulation select-none", variant: "outline", onClick: startRecording, children: [
                  ...
                  " Open Camera & Record (60–90s)"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground text-center", children: "Camera recording is required; uploaded video files are not accepted." })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "w-full", onClick: submitFeedback, disabled: fbSubmitting || recording || !fbText.trim() || !fbVideoFile || videoDuration < 60, children: fbSubmitting ? "Posting..." : "Post Feedback to Community Wall 🤲" }),
            !fbText.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-500", children: "Caption is required before posting." }),
            !fbVideoFile && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-red-500", children: "Video recording is required before posting." }),
        ...
        !isCompleted && !unlocked && !isOwner && !contributionOpen ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-dashed border-border bg-muted/30 p-6 flex flex-col items-center text-center gap-4", children: [
          ...
          !isOwner && unlockMode === "full" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "order-2 min-w-0 overflow-hidden rounded-2xl bg-card border-2 border-primary/20 p-5 space-y-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-teal-200 bg-teal-50/60 dark:bg-teal-950/20 p-3 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-teal-700", children: "Help Seeker Contact (Unlocked)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CopyRow, { label: "Name", value: seekerName }),
              seekerContact ? /* @__PURE__ */ jsxRuntimeExports.jsx(CopyRow, { label: "Mobile Number", value: String(seekerContact), mono: true }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Mobile number is not available in the submitted profile." })
            ] }),
            (isEducationCase || isMedicalCase) && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-indigo-200 bg-indigo-50/60 dark:bg-indigo-950/20 p-3 space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-indigo-700", children: "Verified Case Details" }),
              isEducationCase && educationRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx(CopyRow, { label: row.label, value: String(row.value), mono: row.mono }, row.label)),
              isMedicalCase && medicalRows.map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx(CopyRow, { label: row.label, value: String(row.value), mono: row.mono }, row.label)),
              unlockedProofDocuments.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-1 space-y-1.5", children: unlockedProofDocuments.map((doc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: String(doc.value), target: "_blank", rel: "noopener noreferrer", className: "flex items-center gap-2 text-xs font-semibold text-indigo-700 hover:underline", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FileText, { className: "h-3.5 w-3.5" }),
                " View ",
                doc.label
              ] }, doc.label)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-amber-700", children: "No fee challan, voucher, or medical bill was attached to this approved case." })
            ] }),
        ...
        !isOwner && isCompleted && (myUnlock || myResolutions.length > 0) && (() => {
          const adminDirectResolution = (myUnlock == null ? void 0 : myUnlock.payment_type) !== "partial" && String((caseData == null ? void 0 : caseData.status) || "").toLowerCase() === "completed" && Boolean((caseData == null ? void 0 : caseData.paid_receipt_url) || (caseData == null ? void 0 : caseData.reference_number)) ? {
            ...caseData,
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl bg-teal-50 dark:bg-teal-950/20 border border-teal-200 p-5 text-center space-y-3", children: [
            ...
            verified.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2 pt-1 text-left", children: verified.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-teal-200 bg-card p-3 flex items-center justify-between gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                ...
                r.receipt_url && /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: r.receipt_url, target: "_blank", rel: "noopener noreferrer", className: "mt-1 inline-flex text-xs font-medium text-primary hover:underline", children: "View payment proof" })
              ] }),

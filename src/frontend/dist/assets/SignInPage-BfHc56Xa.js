import { r as reactExports, j as jsxRuntimeExports, d as cn, a as useAuth, u as useNavigate, b as LoadingSpinner, L as Link } from "./index-BoYH-a4m.js";
import { u as useComposedRefs, B as Button } from "./button-DXj5HeE2.js";
import { P as Primitive, u as useControllableState, c as composeEventHandlers, a as createContextScope } from "./index-BjTlUSa6.js";
import { u as usePrevious, a as useSize, C as Check } from "./index-kbCWIHe_.js";
...
function SignInPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen flex items-center justify-center bg-background px-4 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md space-y-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-border bg-card p-8 shadow-sm space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Sign in securely with Internet Identity — no username or password needed." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Checkbox, { id: "remember", "data-ocid": "signin.remember_checkbox" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Label,
          {
            htmlFor: "remember",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: isLoggingIn || isInitializing ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { size: "sm" }) : "Sign In with Internet Identity"
        }
      ),

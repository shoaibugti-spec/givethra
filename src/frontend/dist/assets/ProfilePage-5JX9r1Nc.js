import { c as createLucideIcon, j as jsxRuntimeExports, a2 as cn, r as reactExports, u as useAuth, h as useRole, f as useNavigate, O as useLocation, G as getKycSubmission, a as getProfile, a3 as getProfileStats, o as ue, z as HeartHandshake, w as unfollowUser, x as followUser, a4 as getFollowList, a5 as removeRequester, _ as Wallet } from "./main-g9K_ERoM.js";
import { L as Layout, K as KeyRound, S as Settings } from "./Layout-C2xD75Ts.js";
import { u as useComposedRefs, c as createSlottable, B as Button } from "./button-B16x4Aev.js";
import { D as Dialog$1, a as DialogContent$1, b as DialogClose, c as DialogTitle$1, d as DialogDescription$1, e as DialogPortal$1, f as DialogOverlay$1 } from "./index-Bdi5zlfs.js";
import { X } from "./x-0HxdDPFz.js";
import { u as useId, a as useControllableState, c as composeEventHandlers, P as Presence } from "./index-BObWH-Kc.js";
import { c as createContextScope, u as useLayoutEffect2 } from "./index-8ekuoDiu.js";
import { P as Portal$1, D as DismissableLayer } from "./Combination-TsTJyG2Y.js";
import { c as createPopperScope, R as Root2, A as Anchor, C as Content, a as Root, b as Arrow } from "./index-DuftT9UQ.js";
import { P as Primitive } from "./index-CZZdQ0uj.js";
import { a as isTrulyCompletedHelp, i as isContributionResolution } from "./resolutionStatus-DHDdhFyW.js";
import { a as Mail, M as MessageCircle } from "./message-circle-Ds5NPe60.js";
import { P as Phone } from "./phone-BLo74zS1.js";
...
import { E as Ellipsis } from "./ellipsis-wH7-zJZQ.js";
import { I as Info } from "./info-tgC2LrPD.js";
import { M as MapPin } from "./map-pin-ttbN2WC3.js";
import { C as Calendar } from "./calendar-CRbi6Fwj.js";
...
import { L as LogOut } from "./log-out-ClEG1jBj.js";
import { B as Bell, a as Lock } from "./lock-VvpKTfA-.js";
import { T as Trophy } from "./trophy-APdkvbNf.js";
...
function ProfilePage() {
  ...
  const [profileView, setProfileView] = reactExports.useState("overview");
  ...
  const menuItems = [
    ...
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HeartHandshake, { className: "h-5 w-5" }), label: "My Help Dashboard", to: "/my-help" },
    { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-5 w-5" }), label: "My Cases Dashboard", to: "/my-cases" },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl mx-auto px-4 pt-0 pb-24 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-b-3xl bg-card border border-border shadow-sm overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5", children: [
          ...
          isOwnProfile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 grid grid-cols-2 gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setProfileView("help"), className: `flex items-center justify-center gap-2 rounded-xl border px-3 py-3 text-sm font-semibold transition ${profileView === "help" ? "border-primary bg-primary text-primary-foreground" : "border-primary/20 bg-primary/5 text-primary hover:bg-primary/10"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(HeartHandshake, { className: "h-4 w-4" }),
              " My Help"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "button", onClick: () => setProfileView("cases"), className: `flex items-center justify-center gap-2 rounded-xl border px-3 py-3 text-sm font-semibold transition ${profileView === "cases" ? "border-primary bg-primary text-primary-foreground" : "border-border bg-card text-foreground hover:bg-muted"}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "h-4 w-4" }),
              " My Cases"
            ] })
          ] }),
          isOwnProfile && profileView !== "overview" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 rounded-2xl border border-primary/15 bg-primary/5 p-4", children: profileView === "help" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center gap-2 font-semibold text-primary", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(HeartHandshake, { className: "h-4 w-4" }),
              " My Help"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: heroStats.totalUnlocks }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Total Unlocks" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: heroStats.directHelps }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Direct Helps" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: heroStats.contributions }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Contributions" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: heroStats.totalAmountHelped }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Total Amount Helped" })
              ] })
            ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: requesterStats.totalSubmitted }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Submitted" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: requesterStats.totalApproved }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Approved" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: requesterStats.totalRejected }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Rejected" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl", children: requesterStats.totalCompleted }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Completed" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-2 rounded-xl bg-card p-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-xl text-green-600", children: requesterStats.totalHelpReceived }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: "Total Help Received" })
              ] })
            ] })
          ] }) }),

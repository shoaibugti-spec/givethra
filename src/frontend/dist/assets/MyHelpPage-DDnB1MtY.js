import { u as useAuth, f as useNavigate, r as reactExports, a6 as getCaseResolutionsByHero, P as getCaseUnlocksByHero, Q as getCasesByIds, o as ue, j as jsxRuntimeExports, z as HeartHandshake } from "./main-g9K_ERoM.js";
import { L as Layout } from "./Layout-C2xD75Ts.js";
import { B as Button } from "./button-B16x4Aev.js";
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-C5UnQSCg.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 py-6 space-y-5", children: [
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-20 text-muted-foreground", children: "Loading your help history..." }) : records.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-16 rounded-xl border border-dashed bg-muted/20", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: filteredRecords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-8 text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        ...
        const outcomeMessage = isUnlockOnly ? "🤲 Newborn Hero — you unlocked this case and took the first step toward helping." : record.type === "contribution" ? "🌱 Young Hero — your contribution joined other kind hearts and helped complete this case. May Allah accept your share." : "🦸 Hero — you completed direct help and brought real relief to this family. May Allah reward your generosity.";
        if (isUnlockOnly) {
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 flex-1 min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs leading-relaxed text-teal-700 dark:text-teal-300", children: outcomeMessage }),
            ...
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-start justify-between gap-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 flex-1 min-w-0", children: [
                  ...
                  record.receiptUrl && /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "link", className: "h-auto p-0 text-xs font-medium text-primary", onClick: () => navigate({ to: "/payment-proof/$caseId", params: { caseId: record.caseId } }), children: "View payment proof" })
                ] }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
